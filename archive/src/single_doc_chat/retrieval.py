...
class ConversationalRAG:
    ...
    def _load_llm(self):
        try:
            ...
            raise DocumentPortalException("Failed to load LLM", sys) # type: ignore
    ...
    def _get_session_history(self, session_id: str) -> BaseChatMessageHistory:
        try:
            ...
            raise DocumentPortalException("Failed to retrieve session history", sys) # type: ignore
    ...
    def invoke(self, user_input: str) -> str:
        try:
            ...
            raise DocumentPortalException("Failed to invoke RAG chain", sys) # type: ignore