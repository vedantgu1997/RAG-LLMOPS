...
class SingleDocIngestor:
    def __init__(self,data_dir: str = "data/single_document_chat", faiss_dir: str = "faiss_index"):
        try:
            ...
            raise DocumentPortalException("Initialization error in SingleDocIngestor", sys) #type: ignore
    ...
    def ingest_files(self,uploaded_files):
        try:
            ...
            raise DocumentPortalException("Error during file ingestion", sys) #type: ignore
    ...
    def _create_retriever(self,documents):
        try:
            ...
            raise DocumentPortalException("Error creating FAISS retriever", sys) #type: ignore