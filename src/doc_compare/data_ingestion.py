...
class DocumentIngestion:
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        ...
        try:
            ...
            raise DocumentPortalException("Error saving files", sys) #type: ignore
    ...
    def read_pdf(self, pdf_path: Path) -> str:
        ...
        try:
            ...
            raise DocumentPortalException("Error reading PDF", sys) #type: ignore
    ...
    def combine_documents(self) -> str:
        ...
        try:
            ...
            raise DocumentPortalException("Error combining documents", sys) #type: ignore
    ...
    def clean_old_sessions(self, keep_latest: int = 3):
        ...
        try:
            ...
            raise DocumentPortalException("Error cleaning old sessions", sys) #type: ignore